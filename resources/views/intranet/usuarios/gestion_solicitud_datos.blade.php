        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-11 d-flex align-items-stretch flex-column">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ route('usuario-gestionar_solicitudDatos_guardar') }}" method="POST" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        @if ($solicitudDatos->persona_id != null)
                                            ...
                                            <strong>{{ $solicitudDatos->persona->nombre1 . ' ' . $solicitudDatos->persona->nombre2 . ' ' . $solicitudDatos->persona->apellido1 . ' ' . $solicitudDatos->persona->apellido2 }}</strong>
                                        @else
                                            Empresa que interpone la Petición:
                                            <strong>{{ $solicitudDatos->empresa->razon_social . ' ' . $solicitudDatos->empresa->razon_social . ' ' . $solicitudDatos->empresa->razon_social . ' ' . $solicitudDatos->empresa->razon_social }}</strong>
                                        @endif
                                    </div>
                                    <div class="col-12 col-md-6">
                                        Lugar de adquisición del producto o servicio:
                                        <strong>{{ $solicitudDatos->adquisicion }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        Tipo petición: <strong>{{ $solicitudDatos->tipoPqr->tipo }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <strong>{{ date('Y-m-d', strtotime($solicitudDatos->fecha_generacion . '+ ' . $solicitudDatos->tiempo_limite . ' days')) }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 d-flex flex-wrap rounded border justify-content-center m-2 p-2 ">
                                ...
                                @endif
                                @if ($solicitudDatos->estadospqr_id == 7 || $solicitudDatos->estadospqr_id == 8 || $solicitudDatos->estadospqr_id == 9)
                                ...
                                @elseif($solicitudDatos->estadospqr_id == 10)
                            ...
                            <?php $n_solicitud = 0; ?>
                            @if ($solicitudDatos->prorroga_dias)
                                <div class="menu-card-prorroga menu-card d-none rounded border mb-3 p-2 ">
                                    <div class="col-12 col-md-6">
                                        Días de prorroga: <strong>{{ $solicitudDatos->prorroga_dias }} </strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                                            ...
                                            <div class="row form-recursos">
                                                ...
                                                <div class="card-footer d-flex justify-content-end guardarRecurso">
                                                    <button type="" class="btn btn-primary px-4"
                                                        data_url="{{ route('recurso_guardar_sd') }}"
                                                        data_url_anexos="{{ route('recurso_anexos_guardar_sd') }}"
                            ...
                            <input class="totalGeneralAnexos" id="totalGeneralAnexos" name="totalGeneralAnexos"
                                type="hidden" value="{{ $solicitudDatos->id }}">
                            <input class="totalGeneralaclaraciones" id="totalGeneralaclaraciones"
                                name="totalGeneralaclaraciones" type="hidden" value="{{ $solicitudDatos->id }}">
...
@section('scripts_pagina')
    <script src="{{ asset('js/intranet/solicituddatos/gestion_usuario.js') }}"></script>
@endsection
<!-- ************************************************************* -->

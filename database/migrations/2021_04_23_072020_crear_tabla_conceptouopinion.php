...
class CrearTablaConceptouopinion extends Migration
{
    ...
    public function up()
    {
        Schema::create('conceptouopinion', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('tipo_pqr_id')->default(4);
            $table->foreign('tipo_pqr_id', 'fk_tipoPQR_conceptouopinion')->references('id')->on('tipo_pqr')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('prioridad_id', 'fk_prioridades_conceptouopinion')->references('id')->on('prioridades')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('estadospqr_id', 'fk_estadosconcepto')->references('id')->on('estadospqr')->onDelete('restrict')->onUpdate('restrict');
            $table->timestamps();
            $table->charset = 'utf8';

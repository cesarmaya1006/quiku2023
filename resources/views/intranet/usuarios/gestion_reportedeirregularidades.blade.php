...
@section('cuerpo_pagina')
    ...
    $solicitudes = $reporte->irregularidades->count();
    $solicitudesRespuesta = 0;
    $recursosMenu = 0;
    foreach ($reporte->irregularidades as $solicitud) {
                                ...
                                <div class="col-12 rounded border mb-3 p-2 solicitud_general">
                                    <div class="menu-card-radicado menu-card">
                                        <div class="row">
                                            ...
                                            @if (!$solicitud->otro)
                                                <div class="col-12">
                                                    <p><strong>Tipo de irregularidad:</strong> {{ $solicitud->irregularidad }}</p>
                                                </div>
                                            @else
                                                <div class="col-12">
                                                    <p><strong>Tipo de irregularidad:</strong> {{ $solicitud->irregularidad }}</p>
                                                    ...
                                                    <tbody>
                                                        @foreach ($solicitud->documentos as $anexo)
                                                            <tr>
                                                                ...
                                                                <td><a href="{{ asset('documentos/denuncias/' . $anexo->url) }}"
                                                                        target="_blank"

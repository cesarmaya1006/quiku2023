                    ...
                    <form action="{{ route('funcionario-gestionar_solicitudDatos_guardar') }}" method="POST" autocomplete="off"
                        ...
                        <div class="col-12 rounded border mb-3 p-2">
                            <div class="row">
                                ...
                                @endif
                                <div class="col-12 col-md-6">
                                    Plazo de respuesta prorroga días hábiles: <strong>{{ $solicitudDatos->prorroga_dias }}</strong>
                                </div>
                                <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-12">{{ $solicitud->datossolicitud }}</div>
                                                    </div>
                                                    <div class="row mt-2">
                                                        <h6>Descripción de la solicitud:</h6>
                                                        <div class="col-12">{{ $solicitud->descripcionsolicitud }}</div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-12 contentProrroga" id="contentProrroga">
                                        ...
                                        @if($solicitudDatos->estadospqr_id < 6 && $solicitudDatos->prorroga == 0)
                                            <div class="card-footer d-flex justify-content-end" id="guardarProrroga">
                                                <button type="" class="btn btn-primary px-4" data_url="{{ route('prorroga_guardar_sd') }}" data_token="{{ csrf_token() }}">Guardar prorroga</button>
                                            </div>
                                        @endif
                                    </div>
                                </div>

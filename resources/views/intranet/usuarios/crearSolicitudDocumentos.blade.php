                        ...
                        <div class="col-12  mt-2 pt-2" id="solicitudes">
                            <div class="col-12 solicitud rounded border mb-3">
                                ...
                                <div class="form-group col-12 indentifiquedocinfo-solicitud">
                                    <label for="" class="requerido">Identifique el documento o información requerida</label>
                                    <input class="form-control" type="text" name="indentifiquedocinfo" id="indentifiquedocinfo" required>
                                </div>

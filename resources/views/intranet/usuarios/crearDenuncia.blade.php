        ...
        <div class="col-12">
            <div class="card card-primary">
                ...
                <form action="{{ route('usuario-gererarDenuncia-guardar') }}" method="POST" autocomplete="off"
                        ...
                        <div class="col-12  mt-2 pt-2" id="irregularidades">
                            <div class="col-12 irregularidad rounded border mb-3">
                                <div class="form-group col-12 mt-2 titulo-irregularidad">
                                    ...
                                    <select name="tipo_irregularidad" id="tipo_irregularidad" class="custom-select rounded-0 tipo_irregularidad" required>
                                        <option value="">--Seleccione--</option>
                                ...
                                <input class="cantidadHechosIrregularidad" id="cantidadHechosIrregularidad" name="cantidadHechosIrregularidad" type="hidden" value="0">
                                <input class="cantidadAnexosIrregularidad" id="cantidadAnexosIrregularidad" name="cantidadAnexosIrregularidad" type="hidden" value="0">
                            </div>
                        </div>
                        <input class="cantidadIrregularidades" id="cantidadIrregularidades" name="cantidadIrregularidades" type="hidden" value="0">
                        <div class="col-12 d-flex justify-content-end flex-row">
                    ...
                    <input class="totalCantidadAnexosIrregularidades" id="totalCantidadAnexosIrregularidades" name="totalCantidadAnexosIrregularidades" type="hidden" value="0">
                </form>
            </div>
        </div>
    </div>

                    ...
                    <form action="{{ route('funcionario-gestionar_solicitudDocInfo_guardar') }}" method="POST" autocomplete="off"
                        ...
                        <div class="col-12 rounded border mb-3 p-2">
                            <div class="row">
                                ...
                                @endif
                                <div class="col-12 col-md-6">
                                    Plazo de respuesta prórroga días hábiles: <strong>{{ $solicitud_doc->prorroga_dias }}</strong>
                                </div>
                                <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-12 text-justify">{{ $solicitud->justificacion }}</div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-12 contentProrroga" id="contentProrroga">
                                        <div class="col-12 d-flex row">
                                            <div class="col-12 form-group">
                                                ...
                                                <p>El máximo de días de prórroga es: {{$solicitud_doc->tipoPqr->tiempos * 2}}</p>
                                            </div>
                                            <div class="col-12 d-flex row">
                                                <label for="prorroga_pdf">Justificacion de prórroga</label>
                                                <textarea type="text" class="form-control form-control-sm prorroga_pdf text-justify"
                                        ...
                                        @if($solicitud_doc->estadospqr_id < 6 && $solicitud_doc->prorroga == 0)
                                            <div class="card-footer d-flex justify-content-end" id="guardarProrroga">
                                                <button type="" class="btn btn-primary px-4" data_url="{{ route('prorroga_guardar_sdi') }}" data_token="{{ csrf_token() }}">Guardar prórroga</button>
                                            </div>
                                        @endif
                                    </div>
                                </div> 

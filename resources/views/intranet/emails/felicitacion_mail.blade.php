...
<body>
    <div class="row">
        <div class="col-12">
            ...
            <br>
            <p>Estimado Usuario. Hemos rebicido una solicitud con este correo para radicar una nueva Felicitación.</p>
            <p>Puede descargar el resumen en formato pdf pegando el siguiente link en el navegador </p>
            <p>{{ route('felicitacionRadicadaPdf', ['id' => $id_felicitacion]) }}</p>
        </div>
        <div class="col-12">

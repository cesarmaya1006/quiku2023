                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ route('funcionario-gestionar_pqr_p_guardar') }}" method="POST" autocomplete="off"
                                ...
                                @if (session('id_usuario') == $peticion->empleado_id)
                                    ...
                                    <div class="col-12 peticion_general rounded border mb-3 p-2">
                                            ...
                                            @if ($pqr->estadospqr_id < 6)
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12 d-flex justify-content-end flex-row">
                                                        <button
                                                            class="btn btn-info btn-xs btn-sombra pl-2 pr-2 crearAclaracion"><i
                                                                class="fa fa-plus-circle mr-2" aria-hidden="true"></i>
                                                            Añadir
                                        ...
                                        <div class="row">
                                            ...
                                            @endif
                                            <input class="totalPeticionAnexos" id="totalPeticionAnexos"
                                                name="totalPeticionAnexos" type="hidden" value="0">
                                        </div>
                                        <hr>
                                        <div class="row">
                            ...
                            <input class="id_estado_pqr" id="id_estado_pqr" type="hidden"
                                value="{{ $pqr->estadospqr_id }}">
                        </form>
                    </div>
                </div>
            </div>

...
if(document.querySelectorAll('.editarResuelve')){
    ...
    function editarResuelve(resuelve){
        ...
        let contenidoAnteriorResuelve = tdResuelve.querySelector('.contenido-resuelve').innerText
        ...
        let textareaResuelveEditar = modalResuelveEditar.querySelector('.mensaje-resuelve-editar')
        let btnGuardarResuelve = modalResuelveEditar.querySelector('.editarResuelveGuardar')
        textareaResuelveEditar.value = contenidoAnteriorResuelve

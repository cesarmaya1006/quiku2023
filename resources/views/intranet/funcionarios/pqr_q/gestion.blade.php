                    ...
                    <form action="{{ route('funcionario-gestionar_pqr_p_guardar') }}" method="POST" autocomplete="off"
                        ...
                        <div class="col-12 rounded border mb-3 p-2">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    Plazo de respuesta prórroga días hábiles: <strong>{{ $pqr->prorroga_dias }}</strong>
                                </div>
                                <div class="col-12 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 text-justify">{{ $peticion->motivo->sub_motivo }}</div>
                                                        @if($peticion->otro)
                                                    ...
                                                    <div class="row mt-2">
                                                        <h6>Justificacion:</h6>
                                                        <div class="col-12 text-justify">{{ $peticion->justificacion }}</div>
                                                    </div>
                                                </div>
                        ...
                        <input class="id_estado_pqr" id="id_estado_pqr" type="hidden" value="{{$pqr->estadospqr_id}}">
                    </form>
                </div>
            </div>
        </div>

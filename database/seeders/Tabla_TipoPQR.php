...
class Tabla_TipoPQR extends Seeder
{
    ...
    public function run()
    {
        $tipos = [
            ...
            ['tipo' => 'Consulta', 'descripcion' => 'Solicite una opinión, concepto o posición sobre un asunto', 'url' => 'usuario-generarConsulta'],
            ['tipo' => 'Solicitud sobre mis datos personales', 'descripcion' => 'Solicite rectificaciones, correcciones, suprimir y/o conocer los datos personales que se encuentran en nuestras bases de datos', 'url' => 'usuario-generarFelicitacion'],
            ['tipo' => 'Reportar una irregularidad', 'descripcion' => 'Ponga en nuestro conocimiento una posible irregularidad o delito que haya conocido en nuestra empresa', 'url' => 'usuario-reporteIrregularidad'],
            ['tipo' => 'Felicitación', 'descripcion' => '¿Quiere hacer un reconocimiento a nuestro trabajo o a uno de nuestros colaboradores? ¡Adelante!', 'url' => 'usuario-generarSolicitudDatos'],

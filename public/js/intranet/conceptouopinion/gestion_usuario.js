window.addEventListener('DOMContentLoaded', function(){
    ...
    function ajustarPeticiones(){
        let peticion = document.querySelectorAll('.solicitud_general')
        for (let i = 0; i < peticion.length; i++) {
            peticion[i].querySelector('.totalsolicitudAclaraciones').name = `totalsolicitudAclaraciones${i}`
            peticion[i].querySelector('.totalsolicitudAclaraciones').value = peticion[i].querySelectorAll('.aclaracion').length
            peticion[i].querySelector('.id_solicitud').name = `id_solicitud${i}`
        }
    }
    ...
    function guardarRecurso(e){
        ...
        let idPeticionRecurso = contenedor.querySelector('.id_solicitudRecurso').value

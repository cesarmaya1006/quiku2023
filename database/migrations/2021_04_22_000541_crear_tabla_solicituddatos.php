...
class CrearTablaSolicituddatos extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('solicituddatos', function (Blueprint $table) {
            ...
            $table->foreign('empleado_id', 'fk_empleado_solicituddatos')->references('id')->on('empleados')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('prioridad_id', 'fk_prioridades_solicituddatos')->references('id')->on('prioridades')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('estadospqr_id', 'fk_estadossolicituddatos')->references('id')->on('estadospqr')->onDelete('restrict')->onUpdate('restrict');
            $table->timestamps();
            $table->charset = 'utf8';
    ...
    {
        Schema::dropIfExists('solicituddatos');
    }
}

    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-12">
            <div class="card card-primary solicitudDocInfo">
                ...
                <form action="{{ route('usuario-generarSolicitudDocumentos-guardar') }}" method="POST" autocomplete="off"
                enctype="multipart/form-data" id="fromSolicitudDocInfo">
                @csrf
                @method('post')
                    <div class="card-body">
                        ...
                        <div class="col-12" id="anexosSolicitud">
                            <div class="col-12 d-flex row anexosolicitud">
                                <div class="col-12 titulo-anexo d-flex justify-content-between">
                                    <h6>Anexo</h6>
                                    <button type="button" class="btn btn-danger btn-xs btn-sombra pl-2 pr-2 eliminaranexoSolicitud"><i class="fas fa-minus-circle"></i></button>
                                </div>

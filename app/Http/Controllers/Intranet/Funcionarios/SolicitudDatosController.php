        ...
        foreach ($asignaciones as $asignacion) {
            ...
            if ($asignacion->palabra1 != null) {
                ...
                foreach ($pqr->solicitudes as $peticion) {
                    if ($encontrada === 0) {
                        $pos = strpos($peticion->datossolicitud, $asignacion->palabra1);
                        if ($pos !== false) {
                            $encontrada++;
                            $coincidencia++;
                        }
            ...
            if ($asignacion->palabra2 != null) {
                ...
                foreach ($pqr->solicitudes as $peticion) {
                    if ($encontrada === 0) {
                        $pos = strpos($peticion->datossolicitud, $asignacion->palabra2);
                        if ($pos !== false) {
                            $encontrada++;
                            $coincidencia++;
                        }
            ...
            if ($asignacion->palabra3 != null) {
                ...
                foreach ($pqr->solicitudes as $peticion) {
                    if ($encontrada === 0) {
                        $pos = strpos($peticion->datossolicitud, $asignacion->palabra3);
                        if ($pos !== false) {
                            $encontrada++;
                            $coincidencia++;
                        }
            ...
            if ($asignacion->palabra4 != null) {
                ...
                foreach ($pqr->solicitudes as $peticion) {
                    if ($encontrada === 0) {
                        $pos = strpos($peticion->datossolicitud, $asignacion->palabra4);
                        if ($pos !== false) {
                            $encontrada++;
                            $coincidencia++;
                        }

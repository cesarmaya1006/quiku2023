...
<div class="container">
    <div class="container mt-3">
        <h4 class="titulo-principal">Bienvenido al sistema de Registro de Peticiones, Quejas y Reclamos</h4>
    </div>
                        ...
                        <form>
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="password" class="form-control" id="pasaporte" placeholder="Contraseña" required>
                                </div>
                            </div>

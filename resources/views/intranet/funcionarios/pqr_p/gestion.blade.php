                            ...
                            @foreach ($pqr->peticiones as $peticion)
                                ...
                                <div class="col-12 solicitud rounded border mb-3 p-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">{{ $peticion->motivo->sub_motivo }}
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 d-flex flex-row">
                                            <div class="form-check mb-3 mr-4">
                                                <input id="" name="aclaracion{{ $peticion->id }}" type="radio"
                                                    class="form-check-input aclaracion" value="1"
                                                    {{ $peticion->aclaracion == 1 ? 'checked' : '' }}
                                                    {{ $peticion->aclaracion == 1 ? 'disabled' : '' }} />
                                                <label id="_label" class="form-check-label" for="">SI</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input id="" name="aclaracion{{ $peticion->id }}" type="radio"
                                                    class="form-check-input aclaracion" value="0"
                                                    {{ $peticion->aclaracion == 0 ? 'checked' : '' }}
                                                    {{ $peticion->aclaracion == 1 ? 'disabled' : '' }} />
                                                <label id="_label" class="form-check-label" for="">NO</label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12 d-none aclaracion-form">
                                                <div class="col-12 col-md-12 form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="solicitud{{ $peticion->id }}"
                                                        id="solicitud{{ $peticion->id }}">
                                                </div>
                                                <div class="col-12 d-flex row anexo">
                                                    <div class="col-12 col-md-5 form-group">
                                                        <label for="titulo">Título anexo</label>
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="titulo{{ $peticion->id }}"
                                                            id="titulo{{ $peticion->id }}">
                                                    </div>
                                                    <div class="col-12 col-md-5 form-group">
                                                        <label for="documentos">Anexos o Pruebas</label>
...
>>>>>>> 18cb528a825021b7a47d7de14170d0251c5b4e36
                                                ...
                                                <div class="col-12 col-md-12 form-group">
                                                    <label for="respuesta">Respuesta</label>
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="respuesta{{ $peticion->id }}"
                                                        id="respuesta{{ $peticion->id }}">
                                                </div>
                                            </div>
                                            {{-- </form> --}}
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex justify-content-end flex-row mb-3">
                                            <button class="btn btn-success btn-xs btn-sombra pl-2 pr-2 crearAnexo"
                                                id="crearAnexo"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>
                                                Añadir
                                                otro Anexo</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 d-flex flex-row">
                                            <div class="form-check mb-3 mr-4">
                                                <input id="" name="peticion{{ $peticion->id }}" type="radio"
                                                    class="form-check-input peticion" value="1"
                                                    {{ $pqr->recurso == 1 ? 'checked' : '' }} />
                                                <label id="_label" class="form-check-label" for="">SI</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input id="" name="peticion{{ $peticion->id }}" type="radio"
                                                    class="form-check-input peticion" value="0"
                                        ...
                                        <div class="col-12 row px-3 peticion-form d-none">
                                            ...
                                            <span
                                                class="col-12 col-md-6 d-flex justify-content-center align-items-center">Fecha
                                                Max Notificacion:

...
class CrearTablaDenuncias extends Migration
{
    ...
    public function up()
    {
        Schema::create('denuncias', function (Blueprint $table) {
            ...
            $table->foreign('prioridad_id', 'fk_prioridades_denuncias')->references('id')->on('prioridades')->onDelete('restrict')->onUpdate('restrict');
            ...
            $table->foreign('estadospqr_id', 'fk_estadosdenuncias')->references('id')->on('estadospqr')->onDelete('restrict')->onUpdate('restrict');
            $table->timestamps();
            $table->charset = 'utf8';

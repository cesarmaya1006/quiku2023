...
@section('cuerpo_pagina')
    ...
    $solicitudes = $solicitudDocInfo->peticiones->count();
    $solicitudesRespuesta = 0;
    $recursosMenu = 0;
    foreach ($solicitudDocInfo->peticiones as $solicitud) {
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Gestión a Petición Número de radicado:
                            <strong>{{ $solicitudDocInfo->radicado }}</strong>
                        </h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('usuario-gestionar_solicitudDocInfo_guardar') }}" method="POST" autocomplete="off"
                            ...
                            <div class="col-12 solicitud rounded border mb-3 p-2">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        @if ($solicitudDocInfo->persona_id != null)
                                            Persona que interpone la Petición:
                                            <strong>{{ $solicitudDocInfo->persona->nombre1 . ' ' . $solicitudDocInfo->persona->nombre2 . ' ' . $solicitudDocInfo->persona->apellido1 . ' ' . $solicitudDocInfo->persona->apellido2 }}</strong>
                                        @else
                                            Empresa que interpone la Petición:
                                            <strong>{{ $solicitudDocInfo->empresa->razon_social . ' ' . $solicitudDocInfo->empresa->razon_social . ' ' . $solicitudDocInfo->empresa->razon_social . ' ' . $solicitudDocInfo->empresa->razon_social }}</strong>
                                        @endif
                                    </div>
                                    <div class="col-12 col-md-6">
                                        Tipo petición: <strong>{{ $solicitudDocInfo->tipoPqr->tipo }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        Fecha de radicado: <strong>{{ $solicitudDocInfo->fecha_radicado }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        Fecha estimada de respuesta:
                                        <strong>{{ date('Y-m-d', strtotime($solicitudDocInfo->fecha_generacion . '+ ' . $solicitudDocInfo->tiempo_limite . ' days')) }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 d-flex flex-wrap rounded border justify-content-center m-2 p-2 ">
                                ...
                                @endif
                                @if ($solicitudDocInfo->estadospqr_id == 7 || $solicitudDocInfo->estadospqr_id == 8 || $solicitudDocInfo->estadospqr_id == 9)
                                ...
                                @elseif($solicitudDocInfo->estadospqr_id == 10)
                                ...
                                @endif
                                @if ($solicitudDocInfo->estadospqr_id == 6 || $solicitudDocInfo->estadospqr_id == 10 )
                            ...
                            <?php $n_solicitud = 0; ?>
                            @if ($solicitudDocInfo->prorroga_dias)
                                <div class="menu-card-prorroga menu-card d-none rounded border mb-3 p-2 ">
                                    <div class="col-12 col-md-6">
                                        Días de prorroga: <strong>{{ $solicitudDocInfo->prorroga_dias }} </strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                                ...
                                <div class="col-12 rounded border mb-3 p-2 solicitud_general">
                                    <div class="menu-card-radicado menu-card">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <p><strong>Solicitud:</strong> {{ $solicitud->peticion }}</p>
                                            </div>
                                            <div class="col-12">
                                                <p><strong>Identifique el documento o información requerida:</strong> {{ $solicitud->indentifiquedocinfo }}</p>
                                            </div>
                                            <div class="col-12">
                                                <p><strong>Justificaciones de su solicitud:</strong> {{ $solicitud->justificacion }}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="row form-recursos">
                                                ...
                                                <div class="card-footer d-flex justify-content-end guardarRecurso">
                                                    <button type="" class="btn btn-primary px-4"
                                                        data_url="{{ route('recurso_guardar_sdi') }}"
                                                        data_url_anexos="{{ route('recurso_anexos_guardar_sdi') }}"
                            ...
                            <input class="id_pqr" id="id_pqr" name="id_pqr" type="hidden" value="{{ $solicitudDocInfo->id }}">
                            <input class="totalGeneralAnexos" id="totalGeneralAnexos" name="totalGeneralAnexos"
                                type="hidden" value="{{ $solicitudDocInfo->id }}">
                            <input class="totalGeneralaclaraciones" id="totalGeneralaclaraciones"
                                name="totalGeneralaclaraciones" type="hidden" value="{{ $solicitudDocInfo->id }}">
...
@section('scripts_pagina')
    <script src="{{ asset('js/intranet/solicituddocinfo/gestion_usuario.js') }}"></script>
@endsection
<!-- ************************************************************* -->

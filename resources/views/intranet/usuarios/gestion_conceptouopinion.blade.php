...
@section('cuerpo_pagina')
    ...
    $solicitudes = $concepto->peticiones->count();
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-11 d-flex align-items-stretch flex-column">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ route('usuario-gestionar_conceptoUOpinion_guardar') }}" method="POST" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        @if ($concepto->persona_id != null)
                                            ...
                                            <strong>{{ $concepto->persona->nombre1 . ' ' . $concepto->persona->nombre2 . ' ' . $concepto->persona->apellido1 . ' ' . $concepto->persona->apellido2 }}</strong>
                                        @else
                                            Empresa que interpone la Petición:
                                            <strong>{{ $concepto->empresa->razon_social . ' ' . $concepto->empresa->razon_social . ' ' . $concepto->empresa->razon_social . ' ' . $concepto->empresa->razon_social }}</strong>
                                        @endif
                                    </div>
                                    <div class="col-12 col-md-6">
                                        Tipo petición: <strong>{{ $concepto->tipoPqr->tipo }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <strong>{{ date('Y-m-d', strtotime($concepto->fecha_generacion . '+ ' . $concepto->tiempo_limite . ' days')) }}</strong>
                                    </div>
                                    <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 d-flex flex-wrap rounded border justify-content-center m-2 p-2 ">
                                ...
                                @endif
                                @if ($concepto->estadospqr_id == 7 || $concepto->estadospqr_id == 8 || $concepto->estadospqr_id == 9)
                                ...
                                @elseif($concepto->estadospqr_id == 10)
                                ...
                                <div class="col-12 rounded border mb-3 p-2 solicitud_general">
                                    <div class="menu-card-radicado menu-card">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <p><strong>Concepto u opinión:</strong> {{ $solicitud->consulta }}</p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="row form-recursos">
                                                ...
                                                <div class="card-footer d-flex justify-content-end guardarRecurso">
                                                    <button type="" class="btn btn-primary px-4"
                                                        data_url="{{ route('recurso_guardar_cuo') }}"
                                                        data_url_anexos="{{ route('recurso_anexos_guardar_cuo') }}"
                            ...
                            <input class="totalGeneralAnexos" id="totalGeneralAnexos" name="totalGeneralAnexos"
                                type="hidden" value="{{ $concepto->id }}">
                            <input class="totalGeneralaclaraciones" id="totalGeneralaclaraciones"
                                name="totalGeneralaclaraciones" type="hidden" value="{{ $concepto->id }}">
...
@section('scripts_pagina')
    <script src="{{ asset('js/intranet/conceptouopinion/gestion_usuario.js') }}"></script>
@endsection
<!-- ************************************************************* -->
